...
void WallHitsManager::MakeBranch(AnalysisTree::Configuration &config,
                                 TTree *tree) {
  AnalysisTree::BranchConfig modules_branch("forward_wall_hits",
  ...
  fields_int_.insert(
      std::make_pair(MODULE_ID, modules_branch.GetFieldId("module_id")));
  fields_int_.insert(
      std::make_pair(RND_SUB, modules_branch.GetFieldId("rnd_sub")));
  ...
  fields_float_.insert(
      std::make_pair(DISTANCE, modules_branch.GetFieldId("distance")));
  fields_float_.insert(std::make_pair(
      P_CHARGE, modules_branch.GetFieldId("parametrized_charge")));
  fields_int_.insert(
      std::make_pair(D_CHARGE, modules_branch.GetFieldId("discrete_charge")));
